...
void gui::Render()
{
	...
	RenderText("./Button and Text Renderer gui", 10, 10, 1.0f, vec3(244.0f / 255.0f, 12.0f / 255.0f, 116.0f / 255.0f));
...
int main(int argc, char** argv) {
	gameGui.Start("User Interface gui", 800, 600, true, WindowFlag::WINDOWED, 60, 1);
	return 0;
}